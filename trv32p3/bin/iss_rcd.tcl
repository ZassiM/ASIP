...
set iss_name [dict get [tclutils::list2dict [iss info keys iss_option] [iss info issoptions]] iss_name]

set mem_file "$program.$iss_name.mem"
set rcd_file "$program.$iss_name.rcd"
set prf_file "$program.$iss_name.prf"
set ipr_file "$program.$iss_name.ipr"
