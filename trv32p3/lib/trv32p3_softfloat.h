...
unsigned int       f32_to_ui32_r_minMag ( float32_t, bool )               property(functional dont_generate);
unsigned long long f32_to_ui64_r_minMag ( float32_t, bool )               property(functional dont_generate);
  signed int       f32_to_i32_r_minMag  ( float32_t, bool )               property(functional dont_generate);
...
float32_t          f32_roundToInt       ( float32_t, unsigned int, bool ) property(functional dont_generate);
...
unsigned int       f64_to_ui32_r_minMag ( float64_t, bool )               property(functional dont_generate);
unsigned long long f64_to_ui64_r_minMag ( float64_t, bool )               property(functional dont_generate);
  signed int       f64_to_i32_r_minMag  ( float64_t, bool )               property(functional dont_generate);
...
float64_t          f64_roundToInt       ( float64_t, unsigned int, bool ) property(functional dont_generate);
