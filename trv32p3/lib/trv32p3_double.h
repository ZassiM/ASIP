...
#ifndef INCLUDED_TRV32P3_DOUBLE_H_
#define INCLUDED_TRV32P3_DOUBLE_H_
...
inline       signed int        wrap_f64_to_i32   (float64_t a) property(dont_generate)              { return f64_to_i32_r_minMag(a, false); }
inline     unsigned int        wrap_f64_to_ui32  (float64_t a) property(dont_generate)              { return f64_to_ui32_r_minMag(a, false); }
...
inline       signed long long  wrap_f64_to_i64   (float64_t a) property(dont_generate)              { return f64_to_i64_r_minMag(a, false); }
inline     unsigned long long  wrap_f64_to_ui64  (float64_t a) property(dont_generate)              { return f64_to_ui64_r_minMag(a, false); }
...
#endif /* INCLUDED_TRV32P3_DOUBLE_H_ */
