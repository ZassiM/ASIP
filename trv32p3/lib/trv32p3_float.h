...
inline       signed int        wrap_f32_to_i32   (float32_t a) property(dont_generate)              { return f32_to_i32_r_minMag(a, false); }
inline     unsigned int        wrap_f32_to_ui32  (float32_t a) property(dont_generate)              { return f32_to_ui32_r_minMag(a, false); }
...
inline       signed long long  wrap_f32_to_i64   (float32_t a) property(dont_generate)              { return f32_to_i64_r_minMag(a, false); }
inline     unsigned long long  wrap_f32_to_ui64  (float32_t a) property(dont_generate)              { return f32_to_ui64_r_minMag(a, false); }
