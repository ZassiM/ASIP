...
NEVER_INLINE void test_int(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, ...)
{
...
#ifdef HAS_CHAR
NEVER_INLINE void test_char(chess_stack char p0, chess_stack char p1, chess_stack char p2, ...)
{
    chess_message("// test2");
    va_list select;
    va_start(select, p2);
...
#ifdef HAS_SHORT
NEVER_INLINE void test_short(chess_stack short p0, chess_stack short p1, chess_stack short p2, ...)
{
...
#ifdef HAS_LONG
NEVER_INLINE void test_long(chess_stack long p0, chess_stack long p1, chess_stack long p2, ...)
{
...
#ifdef HAS_LONG_LONG
NEVER_INLINE void test_llong(chess_stack long long p0, chess_stack long long p1, chess_stack long long p2, ...)
{
