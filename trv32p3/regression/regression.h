...
// regression parameters for trv32p3 (a 32-bit core)
...
#define INT_NBIT    32
#define INT_MAXSH   (INT_NBIT-1)

#define INT_SE(a)   ((int)(a))
#define INT_ZE(a)   ((unsigned)a)
...
#define DINT_NBIT    (2*INT_NBIT)
#define DINT_MAXSH   (DINT_NBIT-1)
#define DINT_SE(a)   ((long long)(a))
#define DINT_ZE(a)   ((unsigned long long)a)
...
#ifdef HAS_SHORT
#define SHRT_NBIT   16
#define SHRT_ZE(a)  ((unsigned short)a)
#define SHRT_SE(a)  ((short)(a))
...
#define LNG_NBIT    32
#define LNG_MAXSH   (LNG_NBIT-1)
#define LNG_SE(a)   ((long)(a))
#define LNG_ZE(a)   ((unsigned long)a)

// long long type parameters
#ifdef HAS_LONG_LONG
#define LLNG_NBIT   64
#define LLNG_ZE(a)  ((unsigned long long)a)
#define LLNG_SE(a)  ((long long)(a))
