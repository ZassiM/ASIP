...
extern "C++" NEVER_INLINE int bf_add(int x, int y)
{
    BF1 bf0, bf1, bf2;
    bf1.a = x;
    bf1.b = y;
...
extern "C++" NEVER_INLINE void bf_set(BF1& bf, int x, int y)
{
    bf.a = x;
    bf.b = y;
}

extern "C++" NEVER_INLINE int bf_add(BF1 bf)
{
    return bf.a + bf.b;
}
...
extern "C++" NEVER_INLINE void bf_set(BF2& bf, int x, int y)
{
    bf.a = x;
    bf.b = y;
}

extern "C++" NEVER_INLINE int bf_add(BF2 bf)
{
    return bf.a + bf.b;
}
...
extern "C++" NEVER_INLINE void bf_set(BF3& /*chess_storage(XYMEM)*/ bf)
{
    bf.a = 0;
    bf.b = 1;
    bf.c = 2;
...
extern "C++" NEVER_INLINE int bf_add(BF3 bf)
{
    int r = 0;
    r += bf.a;
    r += bf.b;
